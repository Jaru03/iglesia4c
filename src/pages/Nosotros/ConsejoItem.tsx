...
const ConsejoItem = ({item}:Props) => {
  return (
    <article className="flex flex-col items-center py-4">
      <Image src={item?.src} alt={item?.title} width={900} height={900} className=" object-contain consejo__image grayscale hover:grayscale-0 hover:scale-105 transition-all mb-4 "></Image>
