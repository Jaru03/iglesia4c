...
const HowItStarted = () => {
    return (
        <section>
            <div className="p-6 pt-24 flex flex-col gap-6 text-base md:text-base-desktop sm:pt-32 max-w-7xl sm:mx-auto sm:gap-12">
                <h2 className="text-primary-2 text-2xl md:text-2xl-desktop text-center">Comunidad Cristiana Casa de Dios</h2>

                <article>
                    <h3 className="text-primary-2 text-xl md:text-xl-desktop text-center pb-4">¿Cómo Inició?</h3>
                    <p className="md:text-center">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quasi quis quibusdam repudiandae natus fugit, iusto deleniti, veritatis maxime perspiciatis quas sapiente, libero voluptas inventore obcaecati soluta doloremque quae? Aliquid, vero?</p>
                </article>
